...
INSERT INTO PROD (pro_id, fou_id, pro_lbc, pro_lbl, pro_pho, ssrub_id)
	VALUES	('182835', '1', 'KALA U-BASS RUMBLER FRETLESS',
...
-Pré ampli actif Shadow avec les réglages Volume/Tone et accordeur intégré', NULL, 1),
			('166187', '1', 'EAGLESTONE LEONA NATURELLE',
'- Table : Épicéa
- Manche : Erable
...
- Finition : Naturelle', NULL, 1),
			('158197', '1', 'LAG OCCITANIA 66 3/4',
'-Table : Epicéa Sitka
-Dos & Eclisses : Acajou
-Filets : Noir & Ivoire
...
-Sillet de Chevalet : Plat en graphite noir / 75mm', NULL, 2),
			('156059', '1', 'EAGLESTONE SOLEA 3/4 NOIRE',
'- Modèle : 3/4
...
- Finition : Noire' , NULL, 2),
			('126190', '1', 'GRG140 BLACKN BLACK',
'- accastillage chromé 
- corps tilleul 
...
- plaque blanche', NULL, 3),
			('216423', '1', 'X MONARKH SCX7 GLOSS BLACK',
'-Corps acajou
-Vernis brillant
...
-Poids 3.99 kg', NULL, 4),
			('188088', '2', 'FULLPACK CELVIANO AP-260BK NOIR',
...
- 18 sonorités améliorées', NULL, 5),
			('210239', '2', 'CELVIANO GP-500 LAQUE NOIR',
'- Layer
- Split
- Mode duo
...
- Raccordement MIDI (In, Out)',	NULL, 5),
			('145479', '2', 'ROLAND A-49 BLACK',
...
- Finitions blanc nacré et noire', NULL, 6),
...
-1x MIDI Out
-Dimensions : 132,8 x 34,9 x 12,5 cm, poids 20 kg', NULL, 6),
...
-1 Cymbale Crash
-1 Siège
-1 Paire de baguettes 5A', NULL, 7),
...
-Accessoires: Support de tom ', NULL, 7),
...
- Cordon
- Housse de transport
- Livrée en étui avec bec', NULL, 9),
			('191321', '3', 'YCL650II',
'- En Sib
...
- Pads Pisoni
- Livrée en étui avec un bec, étui de type "Français"', NULL, 9),
			('186715', '3', 'DIATONIQUE 2013/20 ROCKET 10 TROUS A LA',
'-Type : diatonique
-Réglage : Richter
-Nombre de trous : 10
-Lames : 20 Laiton
...
-Length : 10 cm', NULL, 10),
			('240899', '3', 'CHROMATIQUE 7582/64 SUPER 64 16 TROUS C DO',
...
- Disponible en Do majeur', NULL, 10),
...
- Cordon rembourré "confort"', NULL, 11),
...
- Bois du Brésil
- Hausse en ébène
- Crin synthétique', NULL, 12),
			('138075', '4', 'ASB 1/2',
'- 1/2
- Bois du Brésil
- Hausse en ébène
- Crin synthétique', NULL, 12),
			('257312', '4', 'ETUI VIOLON CLASSIC MODELE CVK1 4/4',
...
-1 courroie épaule.
-Extérieur TEX noir.
-Intérieur velours gris clair.' , NULL, 13),
			('124893', '4', 'ETUI VIOLON CLASSIC MODELE CVF2 1/4',
'-Ossature en polyfoam
-Housse vissée avec poche partitions noire incorporée
...
-Exterieur Tex noir
-Intérieur velours gris clair', NULL, 13),
			('124672', '4', 'ENSEMBLE VIOLONCELLE SET IDEALE 4/4',
...
-Housse de violoncelle,rembourrage 10 mm,avec poche pour cordes et archet', NULL, 14),
			('814941', '4', 'SET VIOLONCELLE 3/4 VC5S34',
...
- Livré avec archet (bois du Brésil), étui et colophane Piranito', NULL, 14),
...
-(audio, statut du microphone, alim fantôme et données de contrôle).', NULL, 15),
			('159151', '4', 'TLM 103 D',
...
-Livré en pochette de transport avec fermeture éclair', NULL, 16),
			('897316', '5', 'P3S',
...
-Pression Maxi : 144 dB SPL', NULL, 16),
			('150649', '5', 'MPC HP',
...
-Câble de communication avec micro inclus', NULL, 17),
			('833472', '5', 'HD215 II',
...
-Poids sans câble : Environ 280 g', NULL, 17),
			('196243', '5', 'SOUNDLINK CASQUE SUPRA-AURICULAIRE BLUETOOTH NOIR',
'-Casques supra-auraux SoundLink®
-Câble audio de 120 cm
-Câble USB de 33,4 cm
-Étui de transport', NULL, 18),
			('126745', '5', 'CASQUE BLUETOOTH - DT201K',
'-Système Bluetooth
-Récepteur avec connexion USB
-Câbles et adaptateur jack fournis
-Fonctionne avec 2 piles LR6 AAA (fournies)
-Longue portée
-Etui de rangement', NULL, 18)
go
